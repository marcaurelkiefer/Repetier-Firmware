...
#define EXT0_STEPS_PER_MM 90 //385
...
#define HEATED_BED_HEATER_PIN 12 //HEATER_1_PIN
...
#define ORIG_Z_MAX_PIN          MOSI_PIN
...
#define UI_PRINTER_NAME "P802-MHS"
